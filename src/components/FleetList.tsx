...
const PaginationControls = memo(({
  ...
  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-4 border-t pt-4 border-gray-200 dark:border-gray-700">
    <div className="flex items-center space-x-2">
      ...
      >
        <SelectTrigger className="w-[100px] bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white backdrop-blur-md border-gray-200 dark:border-gray-700">
          <SelectValue />
        </SelectTrigger>
    ...
    <div className="flex items-center space-x-2">
      <Button
        ...
        className="bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white hover:bg-opacity-20 backdrop-blur-md border-gray-200 dark:border-gray-700 disabled:opacity-50"
      >
        First
      </Button>
      <Button
  ...
  <Card className={`mb-3 ${theme === 'light' ? 'bg-white' : 'bg-gray-800'} border-gray-200 dark:border-gray-700`}>
    <CardContent className="p-4">
      <div className="flex justify-between items-start mb-2">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <DropdownMenuItem onClick={() => handleFleetSelect(fleet)} className="text-gray-900 dark:text-white">
              Load Fleet
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleToggleShare(fleet)} className="text-gray-900 dark:text-white">
              <div className="flex items-center">
                <Checkbox
                  checked={fleet.shared}
                  className="mr-2 cursor-not-allowed"
            ...
            <DropdownMenuItem onClick={() => handleOpenRenameDialog(fleet)} className="text-gray-900 dark:text-white">
              Rename Fleet
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleFleetCopy(fleet)} className="text-gray-900 dark:text-white">
              Copy Fleet
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleCopyLink(fleet)} className="text-gray-900 dark:text-white">
              Copy Share Link
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleCopyText(fleet)} className="text-gray-900 dark:text-white">
              Copy Fleet Text
            </DropdownMenuItem>
            <DropdownMenuItem 
              onClick={() => handleFleetDelete(fleet)}
      ...
      <div className="grid grid-cols-2 gap-1 text-sm">
        <div className="text-gray-600 dark:text-gray-400">Faction:</div>
        <div className="font-medium text-gray-900 dark:text-white">{fleet.faction.charAt(0).toUpperCase() + fleet.faction.slice(1)}</div>
        
        <div className="text-gray-600 dark:text-gray-400">Commander:</div>
        <div className="font-medium text-gray-900 dark:text-white">{fleet.commander}</div>
        
        <div className="text-gray-600 dark:text-gray-400">Points:</div>
        <div className="font-medium text-gray-900 dark:text-white">{fleet.points}</div>
      </div>
      
      <div className="flex gap-2 mt-3">
        <Button variant="outline" size="sm" className="h-8 p-1 px-2 bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white hover:bg-opacity-20 backdrop-blur-md border-gray-200 dark:border-gray-700" onClick={() => handleFleetSelect(fleet)}>
          Load
        </Button>
        <Button variant="outline" size="sm" className="h-8 p-1 px-2 bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white hover:bg-opacity-20 backdrop-blur-md border-gray-200 dark:border-gray-700" onClick={() => handleFleetCopy(fleet)}>
          <Copy className="h-4 w-4" />
        </Button>
        <Button variant="outline" size="sm" className="h-8 p-1 px-2 bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white hover:bg-opacity-20 backdrop-blur-md border-gray-200 dark:border-gray-700" onClick={() => handleToggleShare(fleet)}>
          <Share className="h-4 w-4" />
        </Button>
        <Button variant="outline" size="sm" className="h-8 p-1 px-2 bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white hover:bg-opacity-20 backdrop-blur-md border-gray-200 dark:border-gray-700" onClick={() => handleOpenRenameDialog(fleet)}>
          <Edit className="h-4 w-4" />
        </Button>
        <Button variant="outline" size="sm" className="h-8 p-1 px-2 bg-white/50 dark:bg-gray-900/50 text-red-600 dark:text-red-400 hover:bg-opacity-20 backdrop-blur-md border-gray-200 dark:border-gray-700" onClick={() => handleFleetDelete(fleet)}>
...
export function FleetList() {
  ...
  const mobileContent = useMemo(() => {
    ...
    return (
      <SheetContent 
        className="w-screen h-[100dvh] max-w-none p-0 border-0 rounded-none mt-0 pt-6 flex flex-col bg-white dark:bg-gray-900 text-gray-900 dark:text-white"
        side="bottom"
      >
        <SheetHeader className="px-4 pb-2">
          <SheetTitle className="text-center text-xl text-gray-900 dark:text-white">Your Fleets</SheetTitle>
          <div className="flex flex-col gap-3 mt-3">
            <Input
              placeholder="Filter fleets..."
              value={searchQuery}
              onChange={handleSearchQueryChange}
              className="w-full bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white backdrop-blur-md border-gray-200 dark:border-gray-700"
            />
            <div className="flex gap-2">
              ...
              >
                <SelectTrigger className="w-full bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white hover:bg-opacity-20 backdrop-blur-md border-gray-200 dark:border-gray-700">
        ...
        <div className="flex-1 overflow-auto px-4 pb-24">
          {isLoading && fleets.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-32">
              ...
              <p className="text-gray-900 dark:text-white">Loading your fleets...</p>
            </div>
          ) : (
            <>
              {fleets.length === 0 ? (
        ...
        {fleets.length > 0 && (
          <SheetFooter className="fixed bottom-0 left-0 right-0 p-4 flex flex-row justify-between items-center border-t bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 backdrop-blur-sm pb-8">
            <Button
              variant="outline"
              size="sm"
  ...
  const dialogContent = useMemo(() => {
    ...
    return (
      <DialogContent className={`max-w-[95vw] sm:max-w-3xl max-h-[90vh] flex flex-col border backdrop-blur-md ${
        ...
        <DialogHeader>
          <DialogTitle className="text-gray-900 dark:text-white">Your Fleets</DialogTitle>
          <div className="flex flex-wrap items-center gap-2 mt-4">
            <Input
              placeholder="Filter fleets..."
              value={searchQuery}
              onChange={handleSearchQueryChange}
              className="max-w-sm bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white backdrop-blur-md border-gray-200 dark:border-gray-700"
            />
            <DropdownMenu open={factionDropdownOpen} onOpenChange={setFactionDropdownOpen}>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="sm" className="bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white hover:bg-opacity-20 backdrop-blur-md border-gray-200 dark:border-gray-700">
                  Faction <ChevronDown className="ml-2 h-4 w-4" />
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent className="max-h-[300px] overflow-auto bg-white dark:bg-gray-800 text-gray-900 dark:text-white border-gray-200 dark:border-gray-700">
                ...
                {totalFactionPages > 1 && (
                  <div className="flex justify-between p-2 border-t mt-2 border-gray-200 dark:border-gray-700">
                    <Button 
                      variant="outline" 
                      size="sm" 
                      onClick={(e) => {
        ...
        <div className="overflow-auto flex-grow border-t border-b border-gray-200 dark:border-gray-700">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center h-32">
              <div className="w-8 h-8 border-4 border-primary border-t-transparent rounded-full animate-spin mb-4"></div>
              <p className="text-gray-900 dark:text-white">Loading your fleets...</p>
    ...
    <>
        ...
        <Sheet open={isDialogOpen} onOpenChange={handleDialogOpenChange}>
          <SheetTrigger asChild>
            <Button
              variant="outline"
              size="sm"
              className="w-full justify-start text-sm font-normal bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white hover:bg-opacity-20 backdrop-blur-md border-gray-200 dark:border-gray-700"
            >
              Fleet List
            </Button>
          </SheetTrigger>
      ...
      {showRenameDialog && fleetToRename && (
        <Dialog open={showRenameDialog} onOpenChange={setShowRenameDialog}>
          <DialogContent className="sm:max-w-[425px] bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border border-gray-200 dark:border-gray-700">
            <DialogHeader>
              <DialogTitle className="text-gray-900 dark:text-white">Rename Fleet</DialogTitle>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                <Input
                  ...
                  className="col-span-4 bg-white/50 dark:bg-gray-900/50 text-gray-900 dark:text-white backdrop-blur-md border-gray-200 dark:border-gray-700"
