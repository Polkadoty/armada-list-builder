...
import { ArrowUpAZ, ArrowDownAZ, ArrowUpNarrowWide, ArrowDownWideNarrow, Star, StarOff, Wrench } from 'lucide-react';
  ...
  const getIcon = (option: SortOption) => {
    if (activeSorts[option] === null) {
      ...
      switch (option) {
        ...
        case 'custom':
          return activeSorts[option] === 'asc' ? <Wrench className="transform rotate-180" /> : <Wrench />;
      }
    }
  };
